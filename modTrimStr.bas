...
'
'   22-Feb-2011  RD Edwards - Refined and optimized
...
'              DESCRIPTION
' -----------  --------------------------------------------------------------
' 21-Apr-1998  Greg Miller
'              TrimNullStr
'              http://www.planet-source-code.com/vb/scripts/ShowCode.asp?txtCodeId=854&lngWId=1
' 22-Feb-2011  RD Edwards
'              Functional TrimNull functions
'              http://www.Planet-Source-Code.com/vb/scripts/ShowCode.asp?txtCodeId=71593&lngWId=1
...
Public Function TrimStr(ByVal strData As String) As String
    ...
    CopyMemory ByVal ArrayPtr(aintChrs), 0&, 4&   ' Empty temp array
    ...
    If (lngLength <> 0) Then
        ...
        ' Calc actual data length
        lngLength = (lngEnd - lngStart) + 1
    End If
    
    If (lngLength > 0) Then
        ' Format data to be returned
        TrimStr = Mid$(strData, lngStart, lngLength)
    Else
        ' Return original data without
        ' leading and trailing blanks
        TrimStr = Trim$(strData)
    End If
